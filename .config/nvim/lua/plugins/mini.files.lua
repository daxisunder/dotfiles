return {
  ...
  config = function()
  -- Code snippet bellow is used to show git status of files in cwd
  -- code is from  https://gist.github.com/bassamsdata/eec0a3065152226581f8d4244cce9051#file-notes-md
