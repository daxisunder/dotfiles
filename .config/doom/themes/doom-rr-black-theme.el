;;; doom-rr-black-theme.el --- port of ir_black -*- lexical-bindings: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-rr-black-theme nil
  "Options for the `doom-rr-black' theme."
  :group 'doom-themes)

(defcustom doom-rr-black-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-rr-black-theme
  :type 'boolean)

(defcustom doom-rr-black-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-rr-black
  ...
  ((bg         '("#000000" "black"   "black"        ))
   ...
   (selection      cyan)
   (builtin        magenta)
   (comments       (if doom-rr-black-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if doom-rr-black-brighter-comments dark-cyan base5) 0.25))
   (constants      green-alt)
   ...
   ;; custom categories
   (-modeline-pad
    (when doom-rr-black-padded-modeline
      (if (integerp doom-rr-black-padded-modeline) doom-ir-black-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :background (if doom-rr-black-brighter-comments (doom-lighten bg 0.05)))
...
;;; doom-rr-black-theme.el ends here
