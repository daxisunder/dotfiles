                                        ;Nothing is copied
;; doom-tokyo-night-black-theme.el --- inspired by VSCode's Tokyo Night theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defcustom doom-tokyo-night-black-padded-modeline nil
...
(def-doom-theme doom-tokyo-night-black
  ...
  ;; "#1a1b26" "#1a1b26" => Editor background (Storm)
  ;; "#000000" "#000000" => Editor background (Night)

  ;; name        default   256       16
  ((bg         '("#000000" nil       nil            ))
   (bg-alt     '("#000000" nil       nil            ))
   (base0      '("#1a1b26" "#1a1b26" "black"        ))
   (base1      '("#414868" "#414868" "brightblack"  ))
   (base2      '("#51587a" "#51587a" "brightblack"  ))
   (base3      '("#61698b" "#61698b" "brightblack"  ))
   (base4      '("#71799d" "#71799d" "brightblack"  ))
   (base5      '("#8189af" "#8189af" "brightblack"  ))
   (base6      '("#9099c0" "#9099c0" "brightblack"  ))
   (base7      '("#a0aad2" "#a0aad2" "brightblack"  ))
   ...
   (selection      base0)
   (builtin        red)
   (comments       (if doom-tokyo-night-black-brighter-comments base5 base1))
   (doc-comments   (doom-lighten (if doom-tokyo-night-black-brighter-comments base5 base1) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       magenta)
   (methods        blue)
  ...
  (
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-tokyo-night-black-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (font-lock-doc-face
