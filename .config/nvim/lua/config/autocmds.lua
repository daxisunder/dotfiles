...
-- Sudo write (write with sudo permissions with WW)
usercmd("WW", function()
  local filename = vim.fn.expand("%")
  vim.cmd("silent write !sudo tee " .. vim.fn.shellescape(filename) .. " > /dev/null")
  vim.cmd("edit!")
end, { desc = "Write file with sudo (WW)" })
...
-- orgmode meta-return (insert mode)
autocmd("FileType", {
  pattern = "org",
  callback = function()
